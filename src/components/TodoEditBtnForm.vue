<template>
  <form @submit.prevent="onSubmit">
    ...
    <button type="button" @click="deleteToDo" class="delete-btn">
      <img src="../assets/trash-icon.svg" alt="" class="delete-icon" />
      Delete
      <span class="sr-only">task</span>
    </button>
    <div class="edittask-form-btn-group">
      <button type="button" @click="onCancel" class="btn edit-task-cancel">
        Cancel
        <span class="sr-only">editing task</span>
      </button>
      <button type="submit" class="btn edit-task-save">
        Save Changes
